...
gxp.util = {
     ...
     *      All functions will be called with two arguments - a callback to call
     *      when the sequence is done and a storage object.
     *  :param complete:  ``Function`` A function that will be called when all
     *      other functions report that they are done.  The final callback will
     *      be called with the storage object passed to all other functions.
     ...
     *  final callback is called when all other sequences report that they are
     *  done.
     */
